...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-cmake-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-cmake-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gz-cmake libgz-cmake
# for installing globally
pixi global install gz-cmake libgz-cmake
```
...
It is possible to list all of the versions of `gz-cmake` available on your platform:
...
```
pixi search gz-cmake --channel conda-forge
```
